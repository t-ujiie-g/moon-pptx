...
- [ ] **Phase 3e — Fill / stroke / effect parsers**
  ...
  - [ ] 3e2: Fill ADT (NoFill / SolidFill / GradientFill / PatternFill / BlipFill)
  - [ ] 3e3: Stroke / line (`<a:ln>`)
  - [ ] 3e4: Effects (`<a:effectLst>` — outerShdw / innerShdw / glow / softEdge / blur)
