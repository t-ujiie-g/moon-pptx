...
- [ ] Phase 7a2: type `<c:chart>` header (title / autoTitleDeleted / plotVisOnly / dispBlanksAs / legend) — lifts from the wholesale `space_body` capture into typed fields
- [ ] Phase 7a3: type `<c:plotArea>` + bar / line / pie chart-family bodies
