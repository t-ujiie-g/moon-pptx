...
- [ ] Cell merging (grid_span, row_span) — fields exist; helper builders pending
- [ ] Cell text, fill, borders, margins — `tcPr` currently captured as `XmlElement`; typed fields land in Phase 6d
- [ ] Table styles
