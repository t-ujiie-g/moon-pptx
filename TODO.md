...
| SmartArt build | ❌ identification only | ❌ | △ D1 slice 1 (`add_smartart_mut` — `list` / `process` + cached drawing) ⭐ | ⏳ v0.5 (D1 hierarchical families) |
...
`feature/v0_5`, plus **D1 slice 1** (SmartArt ⭐ — linear `list` /
`process` families with the full five-part DiagramML + cached drawing).
**D1's hierarchical families (org-chart / hierarchy / cycle / pyramid /
matrix / relationship) are the remaining v0.5.0 work.** 1054 tests ×
4 backends.
...
🟡 **D1 — SmartArt builder** ⭐ headline feature *(slice 1 — linear families — landed 2026-06-11)*
